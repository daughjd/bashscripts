...
column_specs = [
    # general stuff
    columns ('FilterMask',
        ['CascadeFilter_12', 'MuonFilter_12', 'DeepCoreFilter_12']),
    'I3EventHeader',
...
def trim_nugen ():
    """Trim nugen data."""
    h5_files = "/data/user/daughjd/grbsearch/hdftabs/Merged_IC86.2012_genie_ic.1460.AllFiles.FINAL.hdf5"
    filename = 'IC86II.GenieNuMu.FinalLevel.hdfdataset'
    mctruth = 'PrimaryNu'
...
def get_simdata_arrays (dataset,simtype="genie"):
...
genie_numu = get_simdata_arrays (gnumu,"genie")
save (genie_numu, 'data_objects/genie_numu.arrays')
