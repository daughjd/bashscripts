...
class SkyMap:
    ...
    def Plot(self, proj, clockwise=False):
        ...
        if self.hotspot == True:
            ...
            if proj == "rectangular":
                plt.scatter(self.ra_maxN , self.dec_maxN, lw=2, facecolor='none', marker='o', s=140)
                ...
                if clockwise == False:
                    ...
                    plt.scatter((360 - self.ra_maxN - 180.0) * np.pi/180, self.dec_maxN * np.pi/180, lw=2, facecolor='none', marker='o', s=80)
