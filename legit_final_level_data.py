...
primary_daughter_diff_numu = AngleBetweenAngles(int_zen_numu,int_azi_numu,primary_zenith_numu,primary_azi_numu)
primary_daughter_diff_nugmu = AngleBetweenAngles(int_zen_nugmu,int_azi_nugmu,primary_zenith_nugmu,primary_azi_nugmu)
primary_daughter_diff_nuge = AngleBetweenAngles(int_zen_nuge,int_azi_nuge,primary_zenith_nuge,primary_azi_nuge)
primary_daughter_diff_nue = AngleBetweenAngles(int_zen_nue,int_azi_nue,primary_zenith_nue,primary_azi_nue)
