...
datums = tables.openFile('third_time/Corsika_7437_0000-3999_Level3.L6Out_Third.hdf5')
...
datums = tables.openFile('third_time/Level4_IC86.2011_corsika.009622.100K.L6Out_Third.hdf5')
...
datums = tables.openFile('third_time/genie_ic.1304_1404.combo_numu_numubar.L6Out_Third.hdf5')
...
datums = tables.openFile('third_time/Level5_nugen_numu_IC86.2013.010090.AllSubs.L6Out_Third.hdf5')
...
datums = tables.openFile('third_time/genie_ic.1104_1204.combo_nue_nuebar.L6Out_Third.hdf5')
...
datums = tables.openFile('third_time/Level5_nugen_nue_IC86.2013.010193.AllSubs.L6Out_Third.hdf5')
...
samp2_final_level_nugmu = ((les_preselect_nugmu==1)*(bdt_les_nugmu>0.0) + (hes_preselect_nugmu==1)*(bdt_hes_nugmu>-0.01))*(numpy.cos(splinemod_zen_nugmu)<0.087)
...
samp2_final_level_nue = ((les_preselect_nue==1)*(bdt_les_nue>0.0) + (hes_preselect_nue==1)*(bdt_hes_nue>-0.01))*(numpy.cos(splinemod_zen_nue)<0.087)
samp2_final_level_nuge = ((les_preselect_nuge==1)*(bdt_les_nuge>0.0) + (hes_preselect_nuge==1)*(bdt_hes_nuge>-0.01))*(numpy.cos(splinemod_zen_nuge)<0.087)
samp2_final_level_c7437 = ((les_preselect_c7437==1)*(bdt_les_c7437>0.0) + (hes_preselect_c7437==1)*(bdt_hes_c7437>-0.01))*(numpy.cos(splinemod_zen_c7437)<0.087)
samp2_final_level_c9622 = (les_preselect_c9622==1)*(bdt_les_c9622>0.0)*(numpy.cos(splinemod_zen_c9622)<0.087)
...
tailcut_samp2_pull_nch_numu_les,tailcut_samp2_median_pull_numu_les = NchBinMedianPull(merged_nch_numu[(samp2_final_level_numu==1)*(les_numu==1)],para_pull_numu[(samp2_final_level_numu==1)*(les_numu==1)])
tailcut_samp2_pull_nch_numu_les,tailcut_samp2_peak_pull_numu_les = RameezPullMethod(merged_nch_numu[(samp2_final_level_numu==1)*(les_numu==1)],para_pull_numu[(samp2_final_level_numu==1)*(les_numu==1)])
...
samp2_pull_nch_numu_les, corrected_samp2_median_pull_numu_les = NchBinMedianPull(merged_nch_numu[(samp2_final_level_numu==1)*(les_numu==1)],corrected_samp2_para_pull_numu[(samp2_final_level_numu==1)*(les_numu==1)])
samp2_pull_nch_nugmu_hes, corrected_samp2_median_pull_nugmu_hes = NchBinMedianPull(merged_nch_nugmu[(samp2_final_level_nugmu==1)*(hes_nugmu==1)],corrected_samp2_para_pull_nugmu[(samp2_final_level_nugmu==1)*(hes_nugmu==1)])

'''
samp1_pull_nch_numu, samp1_median_pull_numu = NchBinMedianPull(merged_nch_numu[(samp1_final_level_numu==1)],para_pull_numu[(samp1_final_level_numu==1)])
samp1_pull_nch_nugmu, samp1_median_pull_nugmu = NchBinMedianPull(merged_nch_nugmu[(samp1_final_level_nugmu==1)],para_pull_nugmu[(samp1_final_level_nugmu==1)])

samp2_pull_nch_numu, samp2_median_pull_numu = NchBinMedianPull(merged_nch_numu[(samp2_final_level_numu==1)],para_pull_numu[(samp2_final_level_numu==1)])
samp2_pull_nch_nugmu, samp2_median_pull_nugmu = NchBinMedianPull(merged_nch_nugmu[(samp2_final_level_nugmu==1)],para_pull_nugmu[(samp2_final_level_nugmu==1)])

samp1_pull_nch_numu, corrected_samp1_median_pull_numu = NchBinMedianPull(merged_nch_numu[(samp1_final_level_numu==1)],corrected_samp1_para_pull_numu[(samp1_final_level_numu==1)])
samp1_pull_nch_nugmu, corrected_samp1_median_pull_nugmu = NchBinMedianPull(merged_nch_nugmu[(samp1_final_level_nugmu==1)],corrected_samp1_para_pull_nugmu[(samp1_final_level_nugmu==1)])

samp2_pull_nch_numu, corrected_samp2_median_pull_numu = NchBinMedianPull(merged_nch_numu[(samp2_final_level_numu==1)],corrected_samp2_para_pull_numu[(samp2_final_level_numu==1)])
samp2_pull_nch_nugmu, corrected_samp2_median_pull_nugmu = NchBinMedianPull(merged_nch_nugmu[(samp2_final_level_nugmu==1)],corrected_samp2_para_pull_nugmu[(samp2_final_level_nugmu==1)])
'''
