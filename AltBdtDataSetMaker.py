...
def make_data():
  ...
  c = avg_distq_data[les_preselect_data] 
  #e = spline_rlogl_data[les_preselect_data]
  d = vetotrackcharge_data[les_preselect_data]
  e = spline_paraspline_diff_data[les_preselect_data] 
...
def make_bgsim():
  ...
  c = avg_distq_c9622[les_preselect_c9622]
  #e = spline_rlogl_c9622[les_preselect_c9622]
  d = vetotrackcharge_c9622[les_preselect_c9622]
  e = spline_paraspline_diff_c9622[les_preselect_c9622]
...
def make_sig_sim():
  ...
  c = avg_distq_numu[les_preselect_numu]
  #e = spline_rlogl_numu[les_preselect_numu]
  d = vetotrackcharge_numu[les_preselect_numu]
  e = spline_paraspline_diff_numu[les_preselect_numu]
